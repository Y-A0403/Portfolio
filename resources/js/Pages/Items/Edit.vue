                  ...
                  <div class="lg:w-4/5 mx-auto flex flex-wrap">
                    ...
                    <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                      <div class="relative">
                        ...
                        <input type="text" id="itemname" name="itemname" v-model="form.itemname"
                      ...
                      <div class="flex">
                        <button class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">更新</button>
                      </div>
                    </div>
